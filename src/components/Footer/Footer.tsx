    ...
    <div className="container-fluid">
      <footer className="d-flex flex-wrap justify-content-evenly align-items-center py-3 my-4 border-top">
        <div className="col-md-4 d-flex align-items-center">
          <a href="#" className="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">Proyecto Integrador</a>
          <span className="mb-3 mb-md-0 text-body-secondary">&copy; UTN 2023</span>
        </div>
          <div><a href="#" className="mb-3 me-2 mb-md-0 text-decoration-none lh-1" style={{color: '#019CA1'}}>Powered by Iván Mendoza</a></div>
